      ...
      <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            title={t.downloadDOC}
            className="hidden md:flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg border border-slate-200 bg-white/90 hover:bg-white text-slate-700 hover:border-slate-300 font-semibold shadow-2xs active:scale-95 transition"
          >
